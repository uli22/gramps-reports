...
#------------------------------------------------------------------------
#
# PeopleCitationsEventRoleRelationXLSReport
#
#------------------------------------------------------------------------
class PeopleCitationsEventRoleRelationXLSReport(Report):
    """
...
#                evdic[eventref.ref].append((self.__db.get_event_from_handle(eventref.ref).get_date_object().get_sort_value(),eventref.ref,eventref.get_role(),self.__db.get_person_from_handle(pe).primary_name.get_name(),pe))
        ...
        column_titles = [_("LNr"), _("Ev ID"),_("Event"), _("Date"), _("Year"), _("Prim_Place"), _("Prim_FamID"), _("Primary"), _("Prim_ID"),_("Prim_Gender"), _("Person"), _("Pers_Gramps_ID"), _("PERS_FAM_ID"), _("Pers_Gender"), _("Pers_BIR_YEAR"),_("Pers_BIR_PLC"), _("Role"), _("Relation")] 
        i = 0
        self.doc.start_row()
...
#------------------------------------------------------------------------
#
# PeopleCitationsEventRoleRelationXLSOptions
#
#------------------------------------------------------------------------
class PeopleCitationsEventRoleRelationXLSOptions(MenuReportOptions):
    """
