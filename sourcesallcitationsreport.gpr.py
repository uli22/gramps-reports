...
plg.id    = 'SourcesAllCitationsReport'
plg.name  = _("Sources Complete Citations Report")
plg.description =  _("Provides a source and Citations with notes")
plg.version = '1.0'
plg.gramps_target_version = '4.1'
plg.status = STABLE
plg.fname = 'sourcesallcitationsreport.py'
plg.ptype = REPORT
plg.authors = ["Hans Ulrich Frink"]
plg.authors_email = ["hansulrich.frink@gmail.com"]
plg.category = CATEGORY_TEXT
plg.reportclass = 'SourcesAllCitationsReport'
plg.optionclass = 'SourcesAllCitationsOptions'
