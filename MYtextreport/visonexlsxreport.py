...
#4.1        evkeys.sort
        ...
        column_titles = [_("Prim_ID"), _("Gramps_ID"),  _("Role"), _("Relation"), _("LNr"), _("Ev ID"),_("Event"), _("Date"), _("EreignisJahr"), _("Age Primary"), _("Age Person"), _("gender Primary"), _("gender Person") , _("Person"),_("Primary"), _("Person birth"), _("Person Clan"),_("Primary Clan"),_("Event Place")] 
        i = 0
        self.doc.start_row()
...
#------------------------------------------------------------------------
#
# VisoneXLSReportOptions
#
#------------------------------------------------------------------------
class VisoneXLSXReportOptions(MenuReportOptions):
    """
