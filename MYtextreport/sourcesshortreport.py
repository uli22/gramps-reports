...
#
#------------------------------------------------------------------------
class SourcesShortReport(Report):
    """
        ...
        if len(liste)>0:
            ...
            for (a,b) in liste:
                ...
                if Fam == 0:
                    ...
                    if relation:
                        print("REL ",relation[0])
                        relation_text = _("%s" % relation[0])
...
####################
                ...
                if Fam == 1:
                    ...
                    relationA = rel_calc.get_one_relationship(
                                                            ...
                                                            self.__db.get_person_from_handle(b))
                    if relationA:
                        relation_textA = _("To groom: %s" % relationA[0])
                    ...
                    relationB = rel_calc.get_one_relationship(
                                                            ...
                                                            self.__db.get_person_from_handle(b))
                    if relationB:
                        relation_textB = _("To bride: %s" % relationB[0])
...
#                                    toYear(self.__db.get_citation_from_handle(c).date))  
                self.doc.write_text (_("         am %s ") % get_date(self.__db.get_citation_from_handle(c)))
                self.doc.end_paragraph()
...
#
#------------------------------------------------------------------------
class SourcesShortOptions(MenuReportOptions):
    """
