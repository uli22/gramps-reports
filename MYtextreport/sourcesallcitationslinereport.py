...
#------------------------------------------------------------------------
#
# SourcesCitationsLineReport
#
#------------------------------------------------------------------------
class SourcesAllCitationsLineReport(Report):
    """
    ...
    def __init__(self, database, options, user):
        ...
        self.sort_by_citation = menu.get_option_by_name('sort_by_citation').get_value()
        self.sort_by_date = menu.get_option_by_name('sort_by_date').get_value()
...
#------------------------------------------------------------------------
#
# SourcesAllCitationsLineOptions
#
#------------------------------------------------------------------------
class SourcesAllCitationsLineOptions(MenuReportOptions):
    """
...
#        para.set(first_indent=-1.5, lmargin=1.5)
    ...
    def __event_table_style(self):
        ...
        self.default_style.add_table_style("SRC-personline", table)
