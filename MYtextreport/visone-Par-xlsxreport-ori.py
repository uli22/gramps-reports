...
#            relation_text = relation_text + str(primpersAhandle)+ " "   + str(primpersBhandle)  + " "   + str(rolepershandle)
    ...
    #                   relation_text = "nicht verwandt"
                ...
                self.doc.write_text(_("%s") %  "LEER-Vater")
                self.doc.end_paragraph()  
                self.doc.end_cell()
...
#4.1        evkeys.sort
        ...
        column_titles = [_("Prim_ID"), _("Gramps_ID"),  _("Role"), _("Relation"), _("Kinship Path"), _("LNr"), _("Ev ID"),_("Event"), _("Date"), _("Year"), _("Age Primary"), _("Age Person"), _("gender Primary"), _("gender Person") , _("Person"),_("Primary"), _("Person birth"), _("Person Clan"),_("Primary Clan"),_("Event Place"),_("FamID"),_("AnzKind")] 
        i = 0
        self.doc.start_row()
