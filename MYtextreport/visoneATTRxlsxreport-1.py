...
from gramps.gen.utils.db import (find_children, find_parents, find_witnessed_people,
                                 get_age, get_birth_or_fallback, get_death_or_fallback)
...
#        """
    ...
    def listpersonref(self):
       ...
       # genderlist = ['w','m']
        ...
        column_titles = [_("Gramps_ID"), _("Gramps_ID"),  _("LNr"), _("Birthdate"), _("Deathdate"),_("Birthyear"), _("Deathyear"), _("Age on Death"), _("gender"), _("Name"),_("LabelID"),_("LabelGT"),_("Clan"),_("Birth Place"),_("Death Place"),_("Birth Country"),_("Death Country")] 
        i = 0
        self.doc.start_row()
