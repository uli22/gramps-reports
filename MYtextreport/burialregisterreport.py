...
#
#------------------------------------------------------------------------
class BurialregisterReport(Report):
    """
...
#        for s in skeys:
        for s in sorted(sc.keys()):
            ...
            for c in ckeys:                                     
                ...
                #####################################
                            # Age primary Person 
                            age = get_age(self.__db, self.__db.get_person_from_handle(b))            
                ########################################
                self.doc.end_paragraph()
                self.doc.end_cell()
                ...
                if age:
                    if age[0]>0:
                        self.doc.write_text(_(" Alter %s J. ") %
                                                        age[0])
                        if age[1]>0:                                    
                        ...
                        if age[1]>0:                                    
                            self.doc.write_text(_(" Alter %s M.") %
                                                        age[1])
                        else:                                   
                            if age[2]>0:                                    
                                self.doc.write_text(_(" Alter %s T.") %
                                                            age[2])                                                        
...
#------------------------------------------------------------------------
#
# BurialregisterOptions
#
#------------------------------------------------------------------------
class BurialregisterOptions(MenuReportOptions):
    """
