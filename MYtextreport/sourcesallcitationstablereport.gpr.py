...
plg.id    = 'SourcesAllCitationsTableReport'
plg.name  = _("Sources Complete Citations Table Report")
plg.description =  _("Provides a source and Citations with notes")
plg.version = '1.0'
plg.gramps_target_version = '4.2'
plg.status = STABLE
plg.fname = 'sourcesallcitationstablereport.py'
plg.ptype = REPORT
plg.authors = ["Hans Ulrich Frink"]
plg.authors_email = ["hansulrich.frink@gmail.com"]
plg.category = CATEGORY_TEXT
plg.reportclass = 'SourcesAllCitationsTableReport'
plg.optionclass = 'SourcesAllCitationsTableOptions'
