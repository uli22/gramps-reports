...
Developed for gramps 4.1.0 under win 8 64bit
...
#
#------------------------------------------------------------------------
class SourcesAllCitationsReport(Report):
    """
...
#                                    toYear(self.__db.get_citation_from_handle(c).date))  
                self.doc.write_text (_(" Date %s ") % get_date(self.__db.get_citation_from_handle(c)))
                self.doc.end_paragraph()
...
#------------------------------------------------------------------------
#
# SourcesAllCitationsOptions
#
#------------------------------------------------------------------------
class SourcesAllCitationsOptions(MenuReportOptions):
    """
