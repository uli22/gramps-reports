...
sys.path.insert(0,'c:\Python27\Lib\site-packages\igraph')
sys.path.insert(0,'c:\Python27\Lib\site-packages\igraph')
from collections import defaultdict, Counter
#from gen.ggettext import gettext as _  
#from Lib.site-packages.igraph import *
...
#                evdic[eventref.ref].append((self.__db.get_event_from_handle(eventref.ref).get_date_object().get_sort_value(),eventref.ref,eventref.get_role(),self.__db.get_person_from_handle(pe).primary_name.get_name(),pe))
        ...
        column_titles = [_("LNr"), _("Ev ID"),_("Event"), _("Date"), _("Primary"), _("Prim_ID"), _("Person"), _("Gramps_ID"), _("Role"), _("Relation")] 
        i = 0
        self.doc.start_row()
...
#
#------------------------------------------------------------------------
class IgraphReportOptions(MenuReportOptions):
    """
